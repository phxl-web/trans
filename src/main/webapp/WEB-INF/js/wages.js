...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  ...
  columns: [[{ field: 'id', checkbox: true }, { field: 'name1', title: '姓名', width: 100 }, { field: 'name2', title: '底薪', width: 100 }, { field: 'name3', title: '岗位工资', width: 100 }, { field: 'name4', title: '综合考评奖励', width: 100 }, { field: 'name5', title: '交通通讯保障', width: 100 }, { field: 'name6', title: '工龄工资', width: 100, textAlign: 'right' }, { field: 'name6', title: '补发', width: 100, textAlign: 'right' }, { field: 'name6', title: '补扣', width: 100, textAlign: 'right' }, { field: 'name6', title: '实发工资', width: 100, textAlign: 'right' }]]
});

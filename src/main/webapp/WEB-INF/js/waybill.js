...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#waybillGrid'), {
  toolbar: [{
    ...
    handler: function handler() {
      ...
      if (len === 0) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["b" /* setFormData */])(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#waybillFf'), selectd[0]);
  ...
  columns: [[{ field: 'id', checkbox: true }, { field: 'name1', title: '运单号', width: 100 }, { field: 'name2', title: '数量', width: 100, align: 'right' }, { field: 'name3', title: '状态', width: 100 }, { field: 'name4', title: '起运地', width: 100 }, { field: 'name5', title: '目的地', width: 100 }, { field: 'name6', title: '托运单位', width: 100 }, { field: 'name7', title: '收车单位', width: 100 }, { field: 'name8', title: '承运商', width: 100 }, { field: 'name9', title: '是否带单', width: 100 }, { field: 'name10', title: '返单时间', width: 100 }, { field: 'name11', title: '修改人', width: 100 }, { field: 'name12', title: '修改时间', width: 100 }]]
});

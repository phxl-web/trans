...
var $grid = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#costGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#costDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#costFf'),
    combobox = {

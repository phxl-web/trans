...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  ...
  columns: [[{ field: 'id', checkbox: true }, { field: 'sendDate', title: '发运日期', width: 100 }, { field: 'waybillNo', title: '运单号', width: 100 }, { field: 'departure', title: '起运地', width: 100 }, { field: 'destination', title: '目的地', width: 100 }, { field: 'amonut', title: '数量', width: 100, align: 'right' }, { field: 'consignOrg', title: '托运单位', width: 100 }, { field: 'price', title: '运价', width: 100 }, { field: 'freight', title: '运费', width: 100 }, { field: 'subsidy', title: '补贴', width: 100 }, { field: 'qualityCost', title: '质损费', width: 100 }, { field: 'otherCost', title: '杂项扣费', width: 100 }, { field: 'gpsCost', title: 'GPS扣款', width: 100 }, { field: 'dbCost', title: '倒板费', width: 100 }, { field: 'advanceCharge', title: '预付款', width: 100 }, { field: 'advanceOilCard', title: '预付油卡', width: 100 }, { field: 'bill', title: '计费金额', width: 100 }, { field: 'modifier', title: '修改人', width: 100 }, { field: 'modifyDate', title: '修改时间', width: 100 }]]
});
...
__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init(__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#editWin'), { title: '编辑' }, function (text) {
  ...
  console.log(isValid);
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["d" /* ajaxPost */])({ url: '../../lib/mock/success.json', method: 'get' }, function (data) {
      //===== 校验结束 =====

...
var $grid = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#incomeGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#incomeDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#incomeFf'),
    combobox = {
  qydSearch: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  mddSearch: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  qyd: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  mdd: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  pp: [{ id: 1, text: '品牌1' }, { id: 2, text: '品牌2' }],
  cx: [{ id: 1, text: '车型1' }, { id: 2, text: '车型2' }]
};
//表格初始化
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["a" /* resetFormData */])($form, function () {
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#qyd').combobox('setValue', '');
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#mdd').combobox('setValue', '');
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#pp').combobox('setValue', '');
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#cx').combobox('setValue', '');
      });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* setFormData */])($form, rows[0], function () {
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#qyd').combobox('setValue', rows[0].departure);
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#mdd').combobox('setValue', rows[0].destination);
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#pp').combobox('setValue', rows[0].brand);
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#cx').combobox('setValue', rows[0].models);
        });
  ...
  title: '收入合同表',
  url: '../../lib/mock/incomeContract.json',
  columns: [[{ field: 'id', checkbox: true }, { field: 'consignment', title: '托运单位', width: 100 }, { field: 'departure', title: '起运地', width: 100 }, { field: 'destination', title: '目的地', width: 100 }, { field: 'models', title: '车型', width: 100 }, { field: 'brand', title: '品牌', width: 100 }, { field: 'freightRates', title: '运价', width: 100, textAlign: 'right' }, { field: 'chargeCyc', title: '结费周期', width: 100 }, { field: 'contractStart', title: '合同开始日期', width: 100 }, { field: 'contractEnd', title: '合同结束日期', width: 100 }, { field: 'modifier', title: '修改人', width: 100 }, { field: 'modifyDate', title: '修改日期', width: 100 }]]
});

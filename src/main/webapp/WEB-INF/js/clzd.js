...
var $grid = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#clzdGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#clzdDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#clzdFf'),
    combobox = {
  clType: [{ id: 1, text: '出差' }, { id: 2, text: '业务招待' }]
};
...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["a" /* resetFormData */])($form, function () {
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#clType').combobox('setValue', '');
      });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* setFormData */])($form, rows[0], function () {
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#clType').combobox('setValue', rows[0].name2); //
        });
  ...
  columns: [[{ field: 'id', checkbox: true }, { field: 'name1', title: '日期', width: 100 }, { field: 'name2', title: '类型', width: 100 }, { field: 'name3', title: '人员', width: 100 }, { field: 'name4', title: '金额', width: 100 }, { field: 'name5', title: '报销人', width: 100 }, { field: 'name6', title: '备注', width: 200 }]]
});
...
//编板按钮
__WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#make').on('click', function () {
  __WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].open(__WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#makeWin'));
});
...
for (var key in combobox) {
  ...
  console.log(__WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#' + key));

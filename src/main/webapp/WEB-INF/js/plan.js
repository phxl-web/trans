...
var $grid = __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#planGrid'),
  ...
  qydCombobox: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  mddCombobox: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }]
};
...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["a" /* resetFormData */])($form, function () {
        __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#cys').combobox('setValue', '').combobox('readonly', false);
      });
  ...
  columns: [[{ field: 'id', checkbox: true }, { field: 'name1', title: '运单号', width: 100 }, { field: 'name2', title: '底盘号', width: 100 }, { field: 'name3', title: '数量', width: 100, align: 'right' }, { field: 'name4', title: '起运地', width: 100 }, { field: 'name5', title: '目的地', width: 100 }, { field: 'name6', title: '品牌', width: 100 }, { field: 'name7', title: '车型', width: 100 }, { field: 'name8', title: '轿运车', width: 100 }, { field: 'name9', title: '车次', width: 100 }, { field: 'name10', title: '托运单位', width: 100 }, { field: 'name11', title: '收车单位', width: 100 }, { field: 'name12', title: '承运商', width: 100 }, { field: 'name13', title: '发运日期', width: 100 }]]
});
...
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbCys').combobox({
  url: '../../lib/mock/brand.json',
  method: 'get',
  width: 200,
  height: 28,
  ...
  onSelect: function onSelect(rec) {
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbCys').combobox('setValue', '');
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbYd').combobox('setValue', '');
    var url = '../../lib/mock/model2.json?id=' + rec.id;
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbJyc').combobox('reload', url);
  }
});
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbJyc').combobox({
  method: 'get',
  width: 200,
  height: 28,
  valueField: 'id',
  textField: 'text',
  onSelect: function onSelect(rec) {
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbZjs').val(rec.zj);
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbLxff').val(rec.lxfs);
  }
});
...
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#make').on('click', function () {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["a" /* resetFormData */])($bbForm, function () {
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbCys').combobox('setValue', '');
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbJyc').combobox('setValue', '');
  });
  var opts = [];
